        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-amber-50 border border-amber-200 p-4 rounded-md">
            <p className="text-amber-800 text-sm">
              <strong>Lưu ý:</strong> Để đăng ký nhà hàng mới, bạn cần chuẩn bị giấy phép kinh
              doanh, thông tin liên hệ và menu của nhà hàng. Chúng tôi sẽ xác minh thông tin của bạn
